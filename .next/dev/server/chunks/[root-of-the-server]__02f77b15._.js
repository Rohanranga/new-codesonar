...
async function fetchRepoContent(owner, repo) {
    try {
        ...
        const relevantFiles = treeData.tree.filter((item)=>{
            ...
            if (path.includes("node_modules") || path.includes("dist/") || path.includes("build/") || path.includes(".git/") || path.includes("coverage/") || path.endsWith(".lock") || path.endsWith(".png") || path.endsWith(".jpg") || path.endsWith(".jpeg") || path.endsWith(".gif") || path.endsWith(".svg") || path.endsWith(".ico") || path.endsWith(".woff") || path.endsWith(".woff2") || path.endsWith(".ttf") || path.endsWith(".eot")) {
                return false;
            }
            // Include ALL source code and configuration files
            const isSource = path.endsWith(".ts") || path.endsWith(".tsx") || path.endsWith(".js") || path.endsWith(".jsx") || path.endsWith(".py") || path.endsWith(".go") || path.endsWith(".java") || path.endsWith(".rs") || path.endsWith(".cpp") || path.endsWith(".c") || path.endsWith(".h") || path.endsWith(".css") || path.endsWith(".scss") || path.endsWith(".html") || path.endsWith(".vue") || path.endsWith(".svelte");
            const isConfig = path.endsWith(".json") || path.endsWith(".yaml") || path.endsWith(".yml") || path.endsWith(".toml") || path.endsWith(".env") || path.endsWith(".env.example") || path.endsWith(".config.js") || path.endsWith(".config.ts");
...
"[project]/src/lib/line-by-line-explainer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    "generateLineByLineExplanation",
    ()=>generateLineByLineExplanation
]);
function generateLineByLineExplanation(file) {
    ...
    const functions = lines.filter((l)=>{
        const t = l.trim();
        return t.startsWith('function ') || t.startsWith('export function ') || t.startsWith('const ') && t.includes('= (') || t.includes('=> ');
    });
...
"[project]/src/lib/version-analyzer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function analyzePackageVersions(files) {
    const packages = [];
    // Find package.json
 ...
 */ function getLatestVersionHint(packageName) {
...
"[project]/src/lib/simple-architecture.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/**
 * Simple, guaranteed-to-work architecture diagram generator
 */ __turbopack_context__.s([
    "generateSimpleArchitectureDiagram",
    ()=>generateSimpleArchitectureDiagram
]);
function generateSimpleArchitectureDiagram(files) {
    // Detect project type
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$line$2d$by$2d$line$2d$explainer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/line-by-line-explainer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$version$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/version-analyzer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$simple$2d$architecture$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/simple-architecture.ts [app-route] (ecmascript)");
;
;
;
;
...
async function analyzeCodebase(files) {
    ...
    try {
        ...
        return {
            ...
            architecture: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$simple$2d$architecture$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateSimpleArchitectureDiagram"])(files),
            errors: [],
            warnings: [],
            packages: (()=>{
                // Analyze package versions from package.json
                const packageInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$version$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["analyzePackageVersions"])(files);
                // Update status by comparing versions
                const packagesWithStatus = packageInfo.map((pkg)=>({
                        ...pkg,
                        status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$version$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareVersions"])(pkg.current, pkg.latest)
                    }));
            ...
            fileAnalysis: files.map((f)=>{
                ...
                return {
                    ...
                    explanation: originalFile ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$line$2d$by$2d$line$2d$explainer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateLineByLineExplanation"])(originalFile) : "No detailed explanation available.",
...
async function analyzeCodebaseLocal(files) {
    ...
    const fileAnalysis = files.sort((a, b)=>b.content.length - a.content.length).map((f)=>{
        ...
        return {
            ...
            content: f.content,
            explanation: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$line$2d$by$2d$line$2d$explainer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateLineByLineExplanation"])(f)
        };
    });
    return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02f77b15._.js.map